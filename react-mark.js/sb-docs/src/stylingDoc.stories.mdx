...
<h2>
  CSS - Single Element&nbsp;
  <TargetBlankLink href="https://stackblitz.com/edit/react-mark-js?file=src/examples/CSSExample/index.js">
    demo ↗
  </TargetBlankLink>
</h2>
...
<h2>
  Styled Components{" "}
  <TargetBlankLink href="https://stackblitz.com/edit/react-mark-js?file=src/examples/StyledComponentsExample/index.js">
    demo ↗
  </TargetBlankLink>
</h2>
