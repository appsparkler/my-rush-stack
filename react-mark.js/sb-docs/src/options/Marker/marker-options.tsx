export const MarkerOptions = () => (
  <table class="options-table">
    ...
    <tbody>
      ...
      <tr>
        <td>separateWordSearch</td>
        <td>boolean</td>
        <td>true</td>
        <td>
          Whether to search for each word separated by a blank instead of the
          complete term
        </td>
      </tr>
      <tr>
        ...
        <td>
          ...
          <ul>
            <li>
              "partially": When searching for "lor" only "lor" inside "lorem"
              will be marked
            </li>
            <li>
              "complementary": When searching for "lor" the whole word "lorem"
              will be marked
            </li>
            <li>
              "exactly": When searching for "lor" only those exact words with a
              word boundary will be marked. In this example nothing inside
              "lorem". This value is equivalent to the previous option{" "}
              <i>wordBoundary</i>
            </li>
          </ul>
          Or an object containing two properties:
          <ul>
            <li>"value": One of the above named string values</li>
            <li>
              "limiters": A custom array of string limiters for accuracy
              "exactly" or "complementary". Read more about this{" "}
              <a href="#accuracy">in the tutorials section</a>
            </li>
          </ul>
        </td>
      </tr>
      <tr>
        ...
        <td>true</td>
        <td>
          If <a href="https://en.wikipedia.org/wiki/Diacritic">diacritic</a>{" "}
          characters should be matched. For example "piękny" would also match
          "piekny" and "doner" would also match "döner"
        </td>
      </tr>
      <tr>
        <td>synonyms</td>
        ...
        <td>{`{ }`}</td>
        <td>
          An object with synonyms. The key will be a synonym for the value and
          the value for the key. Example:
          <code>"synonyms": {`{"one": "1"}`}</code> will add the synonym "1" for
          "one" and vice versa
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>boolean</td>
        <td>false</td>
        <td>Whether to search case sensitive</td>
      </tr>
      <tr>
        <td>ignoreJoiners</td>
        <td>boolean</td>
        <td>false</td>
        <td>
          Whether to also find matches that contain soft hyphen, zero width
          space, zero width non-joiner and zero width joiner. They're used to
          indicate a point for a line break where there isn't enough space to
          show the full word
        </td>
      </tr>
      <tr>
        ...
        <td>[ ]</td>
        <td>
          An array of punctuation mark strings. These punctuation marks can be
          between any characters, e.g. setting this option to <code>["'"]</code>{" "}
          would match "Worlds", "World's" and "Wo'rlds". One or more apostrophes
          between the letters would still produce a match (e.g. "W'o''r'l'd's").
      ...
      <tr>
        ...
        <td>
          ...
          <ul>
            <li>"disabled": Disable wildcard usage</li>
            <li>
              "enabled": When searching for "lor?m", the "?" will match zero or
              one non-space character (e.g. "lorm", "loram", "lor3m", etc). When
              searching for "lor*m", the "*" will match zero or more non-space
              characters (e.g. "lorm", "loram", "lor123m", etc).
            </li>
            <li>
              "withSpaces": When searching for "lor?m", the "?" will match zero
              or one space or non-space character (e.g. "lor m", "loram", etc).
              When searching for "lor*m", the "*" will match zero or more space
              or non-space characters (e.g. "lorm", "lore et dolor ipsum", "lor:
              m", etc).
            </li>
          </ul>
        </td>
      ...
      <tr>
        ...
        <td>
          ...
          <ol>
            ...
            <li>The term that has been found</li>
            <li>
              A counter indicating the total number of all marks at the time of
              the function call
            </li>
            <li>A counter indicating the number of marks for the term</li>
          </ol>
