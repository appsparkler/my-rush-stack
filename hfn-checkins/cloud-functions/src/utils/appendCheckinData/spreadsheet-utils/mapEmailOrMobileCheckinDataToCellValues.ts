import {CheckinWithEmailOrMobileApiStoreData} from "@hfn-checkins/types";
...
export const mapEmailOrMobileCheckinDataToCellValues:
  IMapEmailOrMobileCheckinDataToCellValues =
  map((data) => {
