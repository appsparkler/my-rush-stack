...
(function (global, factory) {
    ...
    class Mark$1 {
        ...
        createSynonymsRegExp(str) {
            const syn = this.opt.synonyms, sens = this.opt.caseSensitive ? '' : 'i', joinerPlaceholder = this.opt.ignoreJoiners ||
            ...
            for (let index in syn) {
                if (syn.hasOwnProperty(index)) {
                    ...
                    if (k1 !== '' && k2 !== '') {
                        str = str.replace(new RegExp(`(${this.escapeStr(k1)}|${this.escapeStr(k2)})`, `gm${sens}`), joinerPlaceholder +
...
//# sourceMappingURL=mark.es6.js.map