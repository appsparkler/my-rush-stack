...
const defaultConfig = {
    ...
    element: 'mark',
    exclude: [],
    filter: (textNode, term, numberOfMarks) => { },
    iframes: false,
    iframesTimeout: 5000,
    ignoreJoiners: false,
    ignorePunctuation: [],
        ...
        react_1.default.createElement(material_1.Grid, { container: true, spacing: 2 },
            react_1.default.createElement(material_1.Grid, { item: true, xs: 6 },
                react_1.default.createElement(mui_1.Vertical, { gap: 2 },
                    ...
                    react_1.default.createElement(DynamicKeyValueList_1.DynamicKeyValueList, { name: "synonyms", onChange: handleChange, value: config.synonyms }),
